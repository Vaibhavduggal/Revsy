...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    return res.json({
      businessName: business.name, googleReviewLink: business.google_review_link || business.googleReviewLink,
      feedbackLink: business.feedback_link || business.feedbackLink,
      messageTemplate: business.message_template || business.messageTemplate,
      delaySeconds: business.delay_seconds || business.delaySeconds,
      demoMode: business.demo_mode || business.demoMode,
      reviewsReceived: business.reviews_received || 0,
    });
  }
