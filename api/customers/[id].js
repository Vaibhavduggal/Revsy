...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    return res.json({
      customer: { id: customer.id, name: customer.name, phone: customer.phone, customMessage: customer.custom_message,
        hasCustomMessage: !!(customer.custom_message && customer.custom_message.trim()),
        stage: customer.stage, sentiment: customer.sentiment, complaint: customer.complaint, createdAt: customer.created_at },
      requests: requests || [],
      conversation: [],
